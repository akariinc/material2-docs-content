...
class CdkListboxActivedescendantExample {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    dependencies: [{
      ...
      type: CdkListbox,
      selector: "[cdkListbox]",
      inputs: ["id", "tabindex", "cdkListboxValue", "cdkListboxMultiple", "cdkListboxDisabled", "cdkListboxUseActiveDescendant", "cdkListboxOrientation", "cdkListboxCompareWith", "cdkListboxNavigationWrapDisabled", "cdkListboxNavigatesDisabledOptions"],
      ...
      type: CdkOption,
      selector: "[cdkOption]",
      inputs: ["id", "cdkOption", "display", "cdkOptionTypeaheadLabel", "cdkOptionDisabled", "tabindex"],
      exportAs: ["cdkOption"]
    }]
  });
}
...
class CdkListboxCompareWithExample {
  slots = [12, 13, 14, 15].map(hour => new Date(today.getFullYear(), today.getMonth(), today.getDate() + 1, hour));
  appointment = [new Date(today.getFullYear(), today.getMonth(), today.getDate() + 1, 14)];
...
class CdkListboxHorizontalExample {
  sizes = ['XS', 'S', 'M', 'L', 'XL', 'SPECIAL'];
  sizes$ = new Map();
  constructor() {
    this.sizes.forEach(size => {
      this.sizes$.set(size, size === 'SPECIAL' ? timer(5000).pipe(take(1), map(() => {
      ...
      })) : timer(5000).pipe(take(1), map(() => `>${size}`)));
    });
  }
  _selectedValue = [];
  get selectedValue() {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    ngImport: i0,
    template: "<!-- #docregion listbox -->\n<label class=\"example-listbox-label\" id=\"example-shirt-size-label\">\n  Shirt Size\n</label>\n<ul cdkListbox\n    cdkListboxOrientation=\"horizontal\"\n    aria-labelledby=\"example-shirt-size-label\"\n    class=\"example-listbox\">\n  @for (size of sizes; track size) {\n    <li [cdkOption]=\"size\" class=\"example-option\"></li>\n  }\n</ul>\n\n<label class=\"example-listbox-label\" id=\"example-shirt-size-label-async\">\n  Shirt Size with async data\n</label>\n<ul cdkListbox\n    cdkListboxOrientation=\"horizontal\"\n    aria-labelledby=\"example-shirt-size-label-async\"\n    [(ngModel)]=\"selectedValue\"\n    class=\"example-listbox\">\n  @for (size of sizes; track size) {\n    <li [cdkOption]=\"size\"\n      [display]=\"sizes$.get(size) | async\"\n      class=\"example-option\"></li>\n  }\n</ul>\n<!-- #enddocregion listbox -->\n",
...
class CdkListboxValueBindingExample {
...
//# sourceMappingURL=cdk-listbox.mjs.map
