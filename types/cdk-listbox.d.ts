...
declare class CdkListboxActivedescendantExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxActivedescendantExample, "cdk-listbox-activedescendant-example", never, {}, {}, never, never, true, never>;
}
...
declare class CdkListboxCompareWithExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxCompareWithExample, "cdk-listbox-compare-with-example", never, {}, {}, never, never, true, never>;
}
...
declare class CdkListboxCustomNavigationExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxCustomNavigationExample, "cdk-listbox-custom-navigation-example", never, {}, {}, never, never, true, never>;
}
...
declare class CdkListboxCustomTypeaheadExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxCustomTypeaheadExample, "cdk-listbox-custom-typeahead-example", never, {}, {}, never, never, true, never>;
}
...
declare class CdkListboxDisabledExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxDisabledExample, "cdk-listbox-disabled-example", never, {}, {}, never, never, true, never>;
}
...
declare class CdkListboxFormsValidationExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxFormsValidationExample, "cdk-listbox-forms-validation-example", never, {}, {}, never, never, true, never>;
}
...
declare class CdkListboxHorizontalExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxHorizontalExample, "cdk-listbox-horizontal-example", never, {}, {}, never, never, true, never>;
}
...
declare class CdkListboxMultipleExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxMultipleExample, "cdk-listbox-multiple-example", never, {}, {}, never, never, true, never>;
}

/** @title Basic listbox. */
declare class CdkListboxOverviewExample {
    static ɵfac: i0.ɵɵFactoryDeclaration<CdkListboxOverviewExample, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxOverviewExample, "cdk-listbox-overview-example", never, {}, {}, never, never, true, never>;
}
...
declare class CdkListboxReactiveFormsExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxReactiveFormsExample, "cdk-listbox-reactive-forms-example", never, {}, {}, never, never, true, never>;
}
...
declare class CdkListboxTemplateFormsExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxTemplateFormsExample, "cdk-listbox-template-forms-example", never, {}, {}, never, never, true, never>;
}
...
declare class CdkListboxValueBindingExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxValueBindingExample, "cdk-listbox-value-binding-example", never, {}, {}, never, never, true, never>;
}
